	...
	<view class="container">
		...
		<view class="footer">
			<view class="footer-btn">
				<button v-if="bgCovername !== bgCoverId"  @tap="setbgCover()">立即使用</button>
				<button v-if="bgCovername === bgCoverId" >使用中</button>
			</view>
		</view>
	</view>
</template>
			...
			getbgCoverList() {
				...
				for (let item of list) {
					let data = {
						name: item.name,
						id: item.img,
						img: `https://cdn.jsdelivr.net/gh/unilei/cdn@2.1/bg/${item.img}.jpg`
					}
